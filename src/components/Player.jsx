/* Player.jsx — Desktop full player bar only
   Mobile uses <MiniPlayer> defined inside App.jsx */
...
export default function Player({
  ...
  /* On mobile, the MiniPlayer in App.jsx handles playback UI.
  ...
  return (
    <footer style={{
      ...
      <div style={{ width: 260, display: "flex", alignItems: "center", gap: 14, flexShrink: 0 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{
            ...
            color: currentSong ? "#ffffff" : "#6b7280",
      ...
      <div style={{
        ...
        alignItems: "center", gap: 10, maxWidth: 620,
      }}>
        ...
        <div style={{ width: "100%", display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div
            ...
            style={{
              flex: 1, height: 4, background: "#2a2a3e", borderRadius: 4,
          ...
          >
            <div style={{ width: `${pct}%`, height: "100%", background: "#ffffff", borderRadius: 4, position: "relative", transition: "width 0.5s linear" }}>
      ...
      {/* RIGHT — volume (180px) */}
      <div style={{ width: 180, display: "flex", alignItems: "center", gap: 8, justifyContent: "flex-end", flexShrink: 0 }}>

        {/* Playing animation bars */}
        {isPlaying && currentSong && (
          <div style={{ display: "flex", alignItems: "flex-end", gap: 2, height: 16, marginRight: 6 }}>
        ...
        <div
          ...
          style={{ flex: 1, height: 4, background: "#2a2a3e", borderRadius: 4, cursor: "pointer", position: "relative", maxWidth: 90 }}
          onMouseEnter={e => e.currentTarget.style.height = "6px"}
          onMouseLeave={e => e.currentTarget.style.height = "4px"}
        >
          <div style={{ width: `${isMuted ? 0 : volume * 100}%`, height: "100%", background: "#ffffff", borderRadius: 4, transition: "width 0.1s" }} />
        </div>
      </div>
